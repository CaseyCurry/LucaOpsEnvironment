...
function transfer_containers {
  ...
  rsync -av --delete --progress --ignore-existing -e 'ssh -o StrictHostKeyChecking=no -i /Users/caseycurry/Documents/LucaInstance.pem' '$directory_to_transfer' centos@$ip:~/containers
}
