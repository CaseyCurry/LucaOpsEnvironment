...
# start selenium
setsid xvfb-run java -jar -Dwebdriver.gecko.driver=/usr/bin/geckodriver /vagrant/dependencies/selenium/selenium-server-standalone-3.2.0.jar >/dev/null 2>&1 < /dev/null &
